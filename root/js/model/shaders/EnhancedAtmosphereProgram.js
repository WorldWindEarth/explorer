...
define(['worldwind'],
    function () {
        ...
        var EnhancedAtmosphereProgram = function (gl, vertexShaderSource, fragmentShaderSource, attribute) {
            ...
            WorldWind.GpuProgram.call(this, gl, vertexShaderSource, fragmentShaderSource, attribute);
        ...
        EnhancedAtmosphereProgram.prototype = Object.create(WorldWind.GpuProgram.prototype);

        /**
         * Returns the atmosphere's altitude.
         * @returns {Number} The atmosphere's altitude in meters.
         */
        EnhancedAtmosphereProgram.prototype.getAltitude = function () {
         ...
         */
        EnhancedAtmosphereProgram.prototype.loadFragMode = function (gl, fragMode) {
            if (!fragMode) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadFragMode", "missingFragMode"));
            }
         ...
         */
        EnhancedAtmosphereProgram.prototype.loadModelviewProjection = function (gl, matrix) {
            if (!matrix) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadModelviewProjection",
                        "missingMatrix"));
            }
         ...
         */
        EnhancedAtmosphereProgram.prototype.loadVertexOrigin = function (gl, vector) {
            if (!vector) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadVertexOrigin", "missingVector"));
            }
         ...
         * @throws {ArgumentError} If the specified vector is null or undefined.
         */
        EnhancedAtmosphereProgram.prototype.loadLightDirection = function (gl, vector) {
            if (!vector) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadLightDirection", "missingVector"));
            }
         ...
         * @throws {ArgumentError} If the specified vector is null or undefined.
         */
        EnhancedAtmosphereProgram.prototype.loadEyePoint = function (gl, vector) {
            if (!vector) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadEyePoint", "missingVector"));
            }
         ...
         * @throws {ArgumentError} If the specified number is null or undefined.
         */
        EnhancedAtmosphereProgram.prototype.loadGlobeRadius = function (gl, globeRadius) {
            if (!globeRadius) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadGlobeRadius",
                        "missingGlobeRadius"));
            }
         ...
         * @param {WebGLRenderingContext} gl The current WebGL context.
         */
        EnhancedAtmosphereProgram.prototype.setScale = function (gl) {
         ...
         */
        EnhancedAtmosphereProgram.prototype.loadTexMatrix = function (gl, matrix) {
            if (!matrix) {
                throw new WorldWind.ArgumentError(
                    WorldWind.Logger.logMessage(WorldWind.Logger.LEVEL_SEVERE, "EnhancedAtmosphereProgram", "loadTexMatrix",
                        "missingMatrix"));
            }
