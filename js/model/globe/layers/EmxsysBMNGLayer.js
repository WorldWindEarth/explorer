...
define([
    ...
    EmxsysBMNGLayer.prototype = Object.create(WorldWind.Layer.prototype);
     ...
     */
    EmxsysBMNGLayer.prototype.refresh = function () {
        if (this.wmtsLayer) {
     ...
     * @protected
     */
    EmxsysBMNGLayer.prototype.doRender = function (dc) {
        if (this.wmtsLayer) {
     ...
     * @protected
     */
    EmxsysBMNGLayer.prototype.isLayerInView = function (dc) {
        if (this.wmtsLayer) {
            return this.wmtsLayer.isLayerInView(dc);
        }
    };

    return EmxsysBMNGLayer;
});